...
public class NotificationService : INotificationService
{
    ...
    public async Task<Notification> SendNotificationAsync(User sender, User recipient, string title, string message, bool viaEmail, Notification.CategoryEnum category, Notification.PriorityEnum priority)
    {
    ...
    public async Task<Notification> SendNotificationToAllAsync(User sender, string title, string message, bool viaEmail, Notification.CategoryEnum category, Notification.PriorityEnum priority)
    {
        var notification = new Notification
        {
            Sender = sender,
    ...
    public async Task<Notification> SendCompleteNotificationAsync(User sender, User recipient, string title, string message, bool viaEmail, Notification.CategoryEnum category, Notification.PriorityEnum priority)
    {
    ...
    public async Task<Notification> SendCompleteNotificationToAllAsync(User sender, string title, string message, bool viaEmail, Notification.CategoryEnum category, Notification.PriorityEnum priority)
    {
