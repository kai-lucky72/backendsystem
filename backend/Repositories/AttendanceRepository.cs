...
public class AttendanceRepository : IAttendanceRepository
{
    ...
    public async Task<IEnumerable<Attendance>> GetByAgentAndDateRangeAsync(long agentId, DateTime startDate, DateTime endDate)
    {
        return await _context.Attendances
            .Include(a => a.Agent)
            .ThenInclude(agent => agent!.User)
    ...
    public async Task<Attendance?> GetFirstByAgentAndTimestampBetweenOrderByTimestampDescAsync(long agentId, DateTime startDateTime, DateTime endDateTime)
    {
        return await _context.Attendances
            .Include(a => a.Agent)
            .ThenInclude(agent => agent!.User)
